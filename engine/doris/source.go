...
func NewDorisSource(task *model.ArchiveTask) (*DorisSource, error) {
...
func (s *DorisSource) GetDBName() string {
	return s.DBName
}

func (s *DorisSource) GetTableName() string {
	return s.TbName
}

func (s *DorisSource) GetColumns() []string {
	return s.Columns
}

func (s *DorisSource) Init() error {
	err := s.getColumns()
	if err != nil {
		return err
	}
...
func (s *DorisSource) GetColumnTypes() (map[string]string, error) {
...
func (s *DorisSource) GetSplitValues() (vals []string, err error) {
	var colType string
...
func (s *DorisSource) GetCount(where string) (cnt int64, err error) {
...
func (s *DorisSource) FetchBatch(ctx context.Context, ch chan<- []any, where string) (cnt int64, err error) {
...
func (s *DorisSource) DeleteBatch(ctx context.Context, limit *rate.Limiter, where string) (cnt int64, err error) {
...
func (s *DorisSource) getColumns() error {
